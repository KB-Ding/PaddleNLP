...
def get_indexed_dataset_(data_prefix, skip_warmup=False):
...
# a = MMapIndexedDataset('/home/PaddleNLP/model_zoo/ernie-1.0/preprocess/baike_sample')
# print(len(a))
# print(a[1])
# print(a[2])
# print(a.get(1))
...
# class Ori_MMapIndexedDataset(paddle.io.Dataset):
#     def __init__(self, path, skip_warmup=False):
#         super().__init__()
...
# b = Ori_MMapIndexedDataset('/home/PaddleNLP/model_zoo/ernie-1.0/preprocess/ori-data/baike_sample')
# print(len(b))
# print(b[1])
# print(b[2])
# print(b.get(1))
